...
class __TwigTemplate_add8182d04a0c11bc1d74e11e557bf200cff0d8b0a5915f5383d1d487e9ed793 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $tags = ["set" => 67, "if" => 79, "trans" => 88];
        $filters = ["clean_class" => 69, "escape" => 77];
        $functions = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null))))) : ("")), 6 => "clearfix"];
  ...
  ";
      ...
      <div";
            // line 87
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["author_attributes"] ?? null), "addClass", [0 => "meta"], "method")), "html", null, true);
            echo ">
        ";
            // line 88
            echo t("<strong>Posted on:</strong> @date <strong>By:</strong> @author_name", array("@date" => ($context["date"] ?? null), "@author_name" => ($context["author_name"] ?? null), ));
            // line 89
            echo "        ";
...
";
    ...
    {
        return array (  115 => 94,  110 => 93,  102 => 89,  100 => 88,  96 => 87,  93 => 86,  91 => 85,  86 => 84,  78 => 81,  73 => 80,  71 => 79,  67 => 78,  62 => 77,  60 => 73,  59 => 72,  58 => 71,  57 => 70,  56 => 69,  55 => 67,);
    }
    ...
    {
        return new Source("", "themes/nexus/templates/node.html.twig", "C:\\xampp\\htdocs\\drupal-8.7.7\\themes\\nexus\\templates\\node.html.twig");
    }
}
